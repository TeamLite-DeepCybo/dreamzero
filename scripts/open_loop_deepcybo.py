...
VIDEO_CAMERAS = {
    "video.image_head":        "observation.images.image_head",
    "video.image_wrist_left":  "observation.images.image_wrist_left",
    "video.image_wrist_right": "observation.images.image_wrist_right",
}

STATE_SLICES = {
    "state.left_joint_pos":    (0, 7),
    "state.right_joint_pos":   (7, 14),
    "state.left_gripper_pos":  (14, 15),
    "state.right_gripper_pos": (15, 16),
}

ACTION_SLICES = {
    "action.left_joint_pos":    (0, 7),
    "action.right_joint_pos":   (7, 14),
    "action.left_gripper_pos":  (14, 15),
