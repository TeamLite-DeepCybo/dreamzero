...
### DeepCybo Lite Post-Training

This fork adds a tested DeepCybo Lite post-training recipe (LoRA, LR 1e-4,
effective batch 16 on the 2xB300 machine). See **[docs/TRAINING.md](docs/TRAINING.md)**
for the full guide: environment, dataset conventions, launch commands, and
where existing checkpoints live. For what this branch is relative to the
inference branch, see [docs/BRANCHES.md](docs/BRANCHES.md).
